 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zt="documentMutations",qt="remoteDocumentsV14",Gt="remoteDocumentGlobal",Wt="targets",Kt="targetDocuments",Ht="targetGlobal",Qt="collectionParents",Jt="clientMetadata",Xt="bundles",Yt="namedQueries",Zt="indexConfiguration",te="indexState",ee="indexEntries",ne="documentOverlays",re="globals",ie=[Bt,$t,zt,Ft,Wt,jt,Ht,Kt,Jt,Gt,Qt,Xt,Yt],se=[Bt,$t,zt,qt,Wt,jt,Ht,Kt,Jt,Gt,Qt,Xt,Yt,ne],oe=se,ae=[...oe,Zt,te,ee];
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ai{constructor(t,e,n,r,i){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(t,e,n){const r=new Map;return r.set(t,ci.createSynthesizedTargetChangeForCurrentChange(t,e,n)),new ai(yt.min(),r,new he(K),er(),lr())}}class ci{constructor(t,e,n,r,i){this.resumeToken=t,this.current=e,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(t,e,n){return new ci(n,e,lr(),lr(),lr())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lc{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new L(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new L(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}_compareTo(t){return K(this._lat,t._lat)||K(this._long,t._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:Lc._jsonSchemaVersion}}static fromJSON(t){if(dt(t,Lc._jsonSchema))return new Lc(t.latitude,t.longitude)}}Lc._jsonSchemaVersion="firestore/geoPoint/1.0",Lc._jsonSchema={type:ft("string",Lc._jsonSchemaVersion),latitude:ft("number"),longitude:ft("number")};
/**
 * @license
 * Copyright 2024 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function au(){return new Wc("serverTimestamp")}const cu="@firebase/firestore",uu="4.14.0";
/**
 * @license
 * Copyright 2017 Google LLC
 *
