 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}(t.datastore,t.asyncQueue,{Zo:Po.bind(null,t),Yo:Lo.bind(null,t),t_:Mo.bind(null,t),H_:Uo.bind(null,t)}),t.Ra.push((async e=>{e?(t.ma.B_(),xo(t)?Oo(t):t.Va.set("Unknown")):(await t.ma.stop(),Do(t))}))),t.ma}function Yo(t){return t.fa||(t.fa=function(t,e,n){const r=D(t);return r.sa(),new yo(e,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)}(t.datastore,t.asyncQueue,{Zo:()=>Promise.resolve(),Yo:Go.bind(null,t),t_:Ho.bind(null,t),ta:Ko.bind(null,t),na:Wo.bind(null,t)}),t.Ra.push((async e=>{e?(t.fa.B_(),await jo(t)):(await t.fa.stop(),t.Ta.length>0&&(A(Eo,`Stopping write stream with ${t.Ta.length} pending writes`),t.Ta=[]))}))),t.fa
/**
 * @license
 * Copyright 2017 Google LLC
 *
