 ...
 * limitations under the License.
 */
class $t{constructor(t,e){this._service=t,this._location=e instanceof D?e:D.makeFromUrl(e,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,e){return new $t(t,e)}get root(){const t=new D(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return yt(this._location.path)}get storage(){return this._service}get parent(){const t=gt(this._location.path);if(null===t)return null;const e=new D(this._location.bucket,t);return new $t(this._service,e)}_throwIfRoot(t){if(""===this._location.path)throw O(t)}}function zt(t,e,n){t._throwIfRoot("uploadBytes");const r=Ut(t.storage,t._location,Et(),new dt(e,!0),n);return t.storage.makeRequestWithTokens(r,Bt).then((e=>({metadata:e,ref:t})))}function qt(t){t._throwIfRoot("getDownloadURL");const e=Pt(t.storage,t._location,Et());return t.storage.makeRequestWithTokens(e,Bt).then((t=>{if(null===t)throw A();return t}))}function Gt(t,e){const n=mt(t._location.path,e),r=new D(t._location.bucket,n);return new $t(t.storage,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jt(t,e){const n=(0,r.j6)(t,"auth");if(n.isInitialized()){const t=n.getImmediate(),r=n.getOptions();if((0,i.bD)(r,e??{}))return t;d(t,"already-initialized")}const s=n.initialize({options:e});return s}function Yt(t,e){const n=e?.persistence||[],r=(Array.isArray(n)?n:[n]).map(ht);e?.errorMap&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(r,e?.popupRedirectResolver)}function Xt(t,e,n){const r=Pt(t);_(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!!n?.disableWarnings,o=Zt(e),{host:a,port:c}=te(e),u=null===c?"":`:${c}`,l={url:`${o}//${a}${u}/`},h=Object.freeze({host:a,port:c,protocol:o.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator)return _(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),void _((0,i.bD)(l,r.config.emulator)&&(0,i.bD)(h,r.emulatorConfig),r,"emulator-config-failed");r.config.emulator=l,r.emulatorConfig=h,r.settings.appVerificationDisabledForTesting=!0,(0,i.zJ)(a)?(0,i.gE)(`${o}//${a}${u}`):s||ne()}function Zt(t){const e=t.indexOf(":");return e<0?"":t.substr(0,e+1)}function te(t){const e=Zt(t),n=/(\/\/)?([^?#/]+)/.exec(t.substr(e.length));if(!n)return{host:"",port:null};const r=n[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const t=i[1];return{host:t,port:ee(r.substr(t.length+1))}}{const[t,e]=r.split(":");return{host:t,port:ee(e)}}}function ee(t){if(!t)return null;const e=Number(t);return isNaN(e)?null:e}function ne(){function t(){const t=document.createElement("p"),e=t.style;t.innerText="Running in emulator mode. Do not use with production credentials.",e.position="fixed",e.width="100%",e.backgroundColor="#ffffff",e.border=".1em solid #000000",e.color="#b50000",e.bottom="0px",e.left="0px",e.margin="0px",e.zIndex="10000",e.textAlign="center",t.classList.add("firebase-emulator-warning"),document.body.appendChild(t)}"undefined"!==typeof console&&"function"===typeof console.info&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),"undefined"!==typeof window&&"undefined"!==typeof document&&("loading"===document.readyState?window.addEventListener("DOMContentLoaded",t):t())}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Xe extends ze{constructor(){super((()=>window.sessionStorage),"SESSION")}_addListener(t,e){}_removeListener(t,e){}}Xe.type="SESSION";const Ze=Xe;
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nn{constructor(t){this.providerId=Nn.PROVIDER_ID,this.auth=Pt(t)}verifyPhoneNumber(t,e){return On(this.auth,t,(0,i.Ku)(e))}static credential(t,e){return ye._fromVerification(t,e)}static credentialFromResult(t){const e=t;return Nn.credentialFromTaggedObject(e)}static credentialFromError(t){return Nn.credentialFromTaggedObject(t.customData||{})}static credentialFromTaggedObject({_tokenResponse:t}){if(!t)return null;const{phoneNumber:e,temporaryProof:n}=t;return e&&n?ye._fromTokenResponse(e,n):null}}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class K{static newId(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=62*Math.floor(256/62);let n="";for(;n.length<20;){const r=G(40);for(let i=0;i<r.length;++i)n.length<20&&r[i]<e&&(n+=t.charAt(r[i]%62))}return n}}function W(t,e){return t<e?-1:t>e?1:0}function H(t,e){const n=Math.min(t.length,e.length);for(let r=0;r<n;r++){const n=t.charAt(r),i=e.charAt(r);if(n!==i)return Y(n)===Y(i)?W(n,i):Y(n)?1:-1}return W(t.length,e.length)}const Q=55296,J=57343;function Y(t){const e=t.charCodeAt(0);return e>=Q&&e<=J}function X(t,e,n){return t.length===e.length&&t.every(((t,r)=>n(t,e[r])))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zt="documentMutations",qt="remoteDocumentsV14",Gt="remoteDocumentGlobal",Kt="targets",Wt="targetDocuments",Ht="targetGlobal",Qt="collectionParents",Jt="clientMetadata",Yt="bundles",Xt="namedQueries",Zt="indexConfiguration",te="indexState",ee="indexEntries",ne="documentOverlays",re="globals",ie=[Bt,$t,zt,Ft,Kt,jt,Ht,Wt,Jt,Gt,Qt,Yt,Xt],se=[Bt,$t,zt,qt,Kt,jt,Ht,Wt,Jt,Gt,Qt,Yt,Xt,ne],oe=se,ae=[...oe,Zt,te,ee];
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ai{constructor(t,e,n,r,i){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=i}static createSynthesizedRemoteEventForCurrentChange(t,e,n){const r=new Map;return r.set(t,ci.createSynthesizedTargetChangeForCurrentChange(t,e,n)),new ai(yt.min(),r,new he(W),er(),lr())}}class ci{constructor(t,e,n,r,i){this.resumeToken=t,this.current=e,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=i}static createSynthesizedTargetChangeForCurrentChange(t,e,n){return new ci(n,e,lr(),lr(),lr())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ts{constructor(t){this.yt=t}}function es(t){const e=Bi({parent:t.parent,structuredQuery:t.structuredQuery});return"LAST"===t.limitType?Gn(e,e.limit,"L"):e}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xs="ConnectivityMonitor";class Zs{constructor(){this.xo=()=>this.Oo(),this.No=()=>this.Bo(),this.Lo=[],this.ko()}Mo(t){this.Lo.push(t)}shutdown(){window.removeEventListener("online",this.xo),window.removeEventListener("offline",this.No)}ko(){window.addEventListener("online",this.xo),window.addEventListener("offline",this.No)}Oo(){A(Xs,"Network connectivity changed: AVAILABLE");for(const t of this.Lo)t(0)}Bo(){A(Xs,"Network connectivity changed: UNAVAILABLE");for(const t of this.Lo)t(1)}static v(){return"undefined"!=typeof window&&void 0!==window.addEventListener&&void 0!==window.removeEventListener}}
/**
 * @license
 * Copyright 2023 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Eo="RemoteStore";class To{constructor(t,e,n,r,i){this.localStore=t,this.datastore=e,this.asyncQueue=n,this.remoteSyncer={},this.Ta=[],this.Ea=new Map,this.Ia=new Set,this.Ra=[],this.Aa=i,this.Aa.Mo((t=>{n.enqueueAndForget((async()=>{No(this)&&(A(Eo,"Restarting streams for network reachability change."),await async function(t){const e=D(t);e.Ia.add(4),await So(e),e.Va.set("Unknown"),e.Ia.delete(4),await Io(e)}(this))}))})),this.Va=new bo(n,r)}}async function Io(t){if(No(t))for(const e of t.Ra)await e(!0)}async function So(t){for(const e of t.Ra)await e(!1)}function Ao(t,e){const n=D(t);n.Ea.has(e.targetId)||(n.Ea.set(e.targetId,e),xo(n)?Oo(n):Yo(n).O_()&&ko(n,e))}function Co(t,e){const n=D(t),r=Yo(n);n.Ea.delete(e),r.O_()&&Ro(n,e),0===n.Ea.size&&(r.O_()?r.L_():No(n)&&n.Va.set("Unknown"))}function ko(t,e){if(t.da.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(yt.min())>0){const n=t.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(n)}Yo(t).Z_(e)}function Ro(t,e){t.da.$e(e),Yo(t).X_(e)}function Oo(t){t.da=new di({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),At:e=>t.Ea.get(e)||null,ht:()=>t.datastore.serializer.databaseId}),Yo(t).start(),t.Va.ua()}function xo(t){return No(t)&&!Yo(t).x_()&&t.Ea.size>0}function No(t){return 0===D(t).Ia.size}function Do(t){t.da=void 0}async function Po(t){t.Va.set("Online")}async function Lo(t){t.Ea.forEach(((e,n)=>{ko(t,e)}))}async function Mo(t,e){Do(t),xo(t)?(t.Va.ha(e),Oo(t)):t.Va.set("Unknown")}async function Uo(t,e,n){if(t.Va.set("Online"),e instanceof hi&&2===e.state&&e.cause)try{await async function(t,e){const n=e.cause;for(const r of e.targetIds)t.Ea.has(r)&&(await t.remoteSyncer.rejectListen(r,n),t.Ea.delete(r),t.da.removeTarget(r))}(t,e)}catch(n){A(Eo,"Failed to remove targets %s: %s ",e.targetIds.join(","),n),await Vo(t,n)}else if(e instanceof ui?t.da.Xe(e):e instanceof li?t.da.st(e):t.da.tt(e),!n.isEqual(yt.min()))try{const e=await Bs(t.localStore);n.compareTo(e)>=0&&await function(t,e){const n=t.da.Tt(e);return n.targetChanges.forEach(((n,r)=>{if(n.resumeToken.approximateByteSize()>0){const i=t.Ea.get(r);i&&t.Ea.set(r,i.withResumeToken(n.resumeToken,e))}})),n.targetMismatches.forEach(((e,n)=>{const r=t.Ea.get(e);if(!r)return;t.Ea.set(e,r.withResumeToken(ve.EMPTY_BYTE_STRING,r.snapshotVersion)),Ro(t,e);const i=new Zi(r.target,e,n,r.sequenceNumber);ko(t,i)})),t.remoteSyncer.applyRemoteEvent(n)}(t,n)}catch(e){A(Eo,"Failed to raise snapshot:",e),await Vo(t,e)}}async function Vo(t,e,n){if(!Rt(e))throw e;t.Ia.add(1),await So(t),t.Va.set("Offline"),n||(n=()=>Bs(t.localStore)),t.asyncQueue.enqueueRetryable((async()=>{A(Eo,"Retrying IndexedDB access"),await n(),t.Ia.delete(1),await Io(t)}))}function Fo(t,e){return e().catch((n=>Vo(t,n,e)))}async function jo(t){const e=D(t),n=Xo(e);let r=e.Ta.length>0?e.Ta[e.Ta.length-1].batchId:xt;for(;Bo(e);)try{const t=await qs(e.localStore,r);if(null===t){0===e.Ta.length&&n.L_();break}r=t.batchId,$o(e,t)}catch(t){await Vo(e,t)}zo(e)&&qo(e)}function Bo(t){return No(t)&&t.Ta.length<10}function $o(t,e){t.Ta.push(e);const n=Xo(t);n.O_()&&n.Y_&&n.ea(e.mutations)}function zo(t){return No(t)&&!Xo(t).x_()&&t.Ta.length>0}function qo(t){Xo(t).start()}async function Go(t){Xo(t).ra()}async function Ko(t){const e=Xo(t);for(const n of t.Ta)e.ea(n.mutations)}async function Wo(t,e,n){const r=t.Ta.shift(),i=Wr.from(r,e,n);await Fo(t,(()=>t.remoteSyncer.applySuccessfulWrite(i))),await jo(t)}async function Ho(t,e){e&&Xo(t).Y_&&await async function(t,e){if(function(t){return Xr(t)&&t!==P.ABORTED}(e.code)){const n=t.Ta.shift();Xo(t).B_(),await Fo(t,(()=>t.remoteSyncer.rejectFailedWrite(n.batchId,e))),await jo(t)}}(t,e),zo(t)&&qo(t)}async function Qo(t,e){const n=D(t);n.asyncQueue.verifyOperationInProgress(),A(Eo,"RemoteStore received new credentials");const r=No(n);n.Ia.add(3),await So(n),r&&n.Va.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.Ia.delete(3),await Io(n)}async function Jo(t,e){const n=D(t);e?(n.Ia.delete(2),await Io(n)):e||(n.Ia.add(2),await So(n),n.Va.set("Unknown"))}function Yo(t){return t.ma||(t.ma=function(t,e,n){const r=D(t);return r.sa(),new mo(e,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}(t.datastore,t.asyncQueue,{Zo:Po.bind(null,t),Yo:Lo.bind(null,t),t_:Mo.bind(null,t),H_:Uo.bind(null,t)}),t.Ra.push((async e=>{e?(t.ma.B_(),xo(t)?Oo(t):t.Va.set("Unknown")):(await t.ma.stop(),Do(t))}))),t.ma}function Xo(t){return t.fa||(t.fa=function(t,e,n){const r=D(t);return r.sa(),new yo(e,r.connection,r.authCredentials,r.appCheckCredentials,r.serializer,n)}(t.datastore,t.asyncQueue,{Zo:()=>Promise.resolve(),Yo:Go.bind(null,t),t_:Ho.bind(null,t),ta:Ko.bind(null,t),na:Wo.bind(null,t)}),t.Ra.push((async e=>{e?(t.fa.B_(),await jo(t)):(await t.fa.stop(),t.Ta.length>0&&(A(Eo,`Stopping write stream with ${t.Ta.length} pending writes`),t.Ta=[]))}))),t.fa
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ya{constructor(t,e,n,r,i){this.asyncQueue=t,this.datastore=e,this.options=n,this.updateFunction=r,this.deferred=i,this.zu=n.maxAttempts,this.M_=new fo(this.asyncQueue,"transaction_retry")}ju(){this.zu-=1,this.Ju()}Ju(){this.M_.p_((async()=>{const t=new Ja(this.datastore),e=this.Hu(t);e&&e.then((e=>{this.asyncQueue.enqueueAndForget((()=>t.commit().then((()=>{this.deferred.resolve(e)})).catch((t=>{this.Zu(t)}))))})).catch((t=>{this.Zu(t)}))}))}Hu(t){try{const e=this.updateFunction(t);return!Nt(e)&&e.catch&&e.then?e:(this.deferred.reject(Error("Transaction callback must return a Promise")),null)}catch(t){return this.deferred.reject(t),null}}Zu(t){this.zu>0&&this.Xu(t)?(this.zu-=1,this.asyncQueue.enqueueAndForget((()=>(this.Ju(),Promise.resolve())))):this.deferred.reject(t)}Xu(t){if("FirebaseError"===t?.name){const e=t.code;return"aborted"===e||"failed-precondition"===e||"already-exists"===e||!Xr(e)}return!1}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}const fc="ComponentProvider",dc=new Map;function pc(t,e,n,r,i){return new Oe(t,e,n,i.host,i.ssl,i.experimentalForceLongPolling,i.experimentalAutoDetectLongPolling,hc(i.experimentalLongPollingOptions),i.useFetchStreams,i.isUsingEmulator,r)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}class kc extends vc{constructor(t,e,n,r){super(t,e,n,r),this.type="firestore",this._queue=new Ac,this._persistenceKey=r?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){const t=this._firestoreClient.terminate();this._queue=new Ac(t),this._firestoreClient=void 0,await t}}}function Rc(t,e){const n="object"==typeof t?t:(0,s.Sx)(),r="string"==typeof t?t:e||xe,i=(0,s.j6)(n,"firestore").getImmediate({identifier:r});if(!i._initialized){const t=(0,a.yU)("firestore");t&&_c(i,...t)}return i}function Oc(t){if(t._terminated)throw new L(P.FAILED_PRECONDITION,"The client has already been terminated.");return t._firestoreClient||xc(t),t._firestoreClient}function xc(t){const e=t._freezeSettings(),n=pc(t._databaseId,t._app?.options.appId||"",t._persistenceKey,t._app?.options.apiKey,e);t._componentsProvider||e.localCache?._offlineComponentProvider&&e.localCache?._onlineComponentProvider&&(t._componentsProvider={_offline:e.localCache._offlineComponentProvider,_online:e.localCache._onlineComponentProvider}),t._firestoreClient=new Za(t._authCredentials,t._appCheckCredentials,t._queue,n,t._componentsProvider&&function(t){const e=t?._online.build();return{_offline:t?._offline.build(e),_online:e}}(t._componentsProvider))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
Ru._jsonSchemaVersion="firestore/querySnapshot/1.0",Ru._jsonSchema={type:ft("string",Ru._jsonSchemaVersion),bundleSource:ft("string","QuerySnapshot"),bundleName:ft("string"),bundle:ft("string")};const xu={maxAttempts:5};
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Nu(t,e){if((t=(0,a.Ku)(t)).firestore!==e)throw new L(P.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return t}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Du{constructor(t,e){this._firestore=t,this._transaction=e,this._dataReader=zc(t)}get(t){const e=Nu(t,this._firestore),n=new Su(this._firestore);return this._transaction.lookup([e._key]).then((t=>{if(!t||1!==t.length)return O(24041);const r=t[0];if(r.isFoundDocument())return new lu(this._firestore,n,r.key,r,e.converter);if(r.isNoDocument())return new lu(this._firestore,n,e._key,null,e.converter);throw O(18433,{doc:r})}))}set(t,e,n){const r=Nu(t,this._firestore),i=Iu(r.converter,e,n),s=qc(this._dataReader,"Transaction.set",r._key,i,null!==r.converter,n);return this._transaction.set(r._key,s),this}update(t,e,n,...r){const i=Nu(t,this._firestore);let s;return s="string"==typeof(e=(0,a.Ku)(e))||e instanceof Dc?Hc(this._dataReader,"Transaction.update",i._key,e,n,r):Wc(this._dataReader,"Transaction.update",i._key,e),this._transaction.update(i._key,s),this}delete(t){const e=Nu(t,this._firestore);return this._transaction.delete(e._key),this}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pu extends Du{constructor(t,e){super(t,e),this._firestore=t}get(t){const e=Nu(t,this._firestore),n=new ou(this._firestore);return super.get(t).then((t=>new Cu(this._firestore,n,e._key,t._document,new Au(!1,!1),e.converter)))}}function Lu(t,e,n){t=ht(t,kc);const r={...xu,...n};!function(t){if(t.maxAttempts<1)throw new L(P.INVALID_ARGUMENT,"Max attempts must be at least 1")}(r);const i=Oc(t);return lc(i,(n=>e(new Pu(t,n))),r)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mu(t){t=ht(t,bc);const e=ht(t.firestore,kc),n=Oc(e);return ac(n,t._key).then((n=>Bu(e,t,n)))}function Uu(t){t=ht(t,wc);const e=ht(t.firestore,kc),n=Oc(e),r=new ou(e);return fu(t._query),cc(n,t._query).then((n=>new Ru(e,r,t,n)))}function Vu(t,e,n){t=ht(t,bc);const r=ht(t.firestore,kc),i=Iu(t.converter,e,n),s=zc(r);return ju(r,[qc(s,"setDoc",t._key,i,null!==t.converter,n).toMutation(t._key,xr.none())])}function Fu(t){return ju(ht(t.firestore,kc),[new qr(t._key,xr.none())])}function ju(t,e){const n=Oc(t);return uc(n,e)}function Bu(t,e,n){const r=n.docs.get(e._key),i=new ou(t);return new Cu(t,i,e._key,r,new Au(n.hasPendingWrites,n.fromCache),e.converter)}new WeakMap;
/**
 * @license
 * Copyright 2023 Google LLC
 *
